  ...
  return (
    <>
      ...
      <div
        ...
        className={`fixed left-0 cursor-pointer top-0 w-full h-full bg-[#147ac8]/[0.6] z-50 ${
          isMenuOpen ? "block" : "hidden"
        }`}
      ></div>
      <nav className="flex items-center justify-between sticky top-0 z-40 p-4 md:px-10 shadow-sm bg-white w-full h-14">
        <div className="flex items-center md:space-x-10 space-x-4 lg:space-x-40">
        ...
        <div className="flex items-center space-x-4 sm:ml-auto ml-[12px]">
          <svg
          ...
          <div className="flex items-center space-x-2">
            ...
            <span className="text-xs hidden sm:block">Alero</span>
          </div>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="h-5 w-5"
