...
const Dashboard: NextPage<Props> = ({children, title}) => {
    ...
    return (
        <>
                ...
                <div className="flex items-center space-x-4">
                    ...
                    <div className="flex items-center space-x-2">
                        <div className="h-7 w-7 rounded-full">
                            <img src="/assets/img/profile-picture.png" alt="Profile" className="w-full h-full object-cover rounded-full"  />
                        </div>
            ...
            <aside className="filter-block transform -translate-x-full md:translate-x-0 w-[233px] fixed min-h-[88%] border-r px-4 py-[18px] bg-white my-4 ml-4 rounded-[10px] flex flex-col justify-between">
                <div>
                    <div className="bg-[#464646] py-7 rounded-md flex items-center justify-center flex-col space-y-4">
                        <div className="h-[90px] w-[90px] bg-white rounded-full p-2">
                            <img src="/assets/img/companylogo.png" alt="Company Logo" className="w-full h-full object-cover"  />
                        </div>
