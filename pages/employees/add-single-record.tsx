    ...
    return (
        <Layout title="Add Employee">
            <div className="bg-white p-[18px] rounded-lg">
                <form className="w-3/5 m-auto my-28">
                    <div>
                        <span className="text-base font-bold border-b border-[#EFEFEF] block mb-6 py-[6px]">Biodata</span>
                    ...
                    <div className="mt-5">
                        <span className="text-base font-bold border-b border-[#EFEFEF] block mb-6 py-[6px]">Employment Details</span>
                        <div className="flex flex-wrap -mx-3 mb-5">
                            <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                                <label className="block text-xs mb-[3px] font-gordita-light">
                                Employee ID
